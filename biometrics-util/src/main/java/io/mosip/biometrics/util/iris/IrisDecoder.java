	...
	public static byte[] convertIrisISOToImageBytes(ConvertRequestDto convertRequestDto) throws Exception {
		...
		case "ISO19794_6_2011":
			...
			case ImageFormat.RGB_JPEG2000:
				...
				return CommonUtil.convertImageToJPEGUsingOpenCV(irisBDIR.getRepresentation().getRepresentationData().getImageData().getImage(), convertRequestDto.getCompressionRatio());
			default:
