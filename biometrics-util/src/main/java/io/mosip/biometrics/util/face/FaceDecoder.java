	...
	public static byte[] convertFaceISOToImageBytes(ConvertRequestDto convertRequestDto) throws Exception {
		...
		case "ISO19794_5_2011":
			...
			case ImageDataType.JPEG2000_LOSS_LESS:
				return CommonUtil.convertImageToJPEGUsingOpenCV(faceBDIR.getRepresentation().getRepresentationData().getImageData().getImage(), convertRequestDto.getCompressionRatio());
