...
public enum ReferenceClassName {
    ...
    UIN_TABLE_READER(ProcessorConstant.DATA_READER, "io.mosip.packet.data.datareader.IDRepoUinTableReaderUtil"),
    ...
    MOSIP_IDREPO_UPLOAD(ProcessorConstant.DATA_POST_PROCESSOR, "io.mosip.packet.data.datapostprocessor.IdrepoUploader"),
    MOSIP_PACKET_DTO_GENERATOR(ProcessorConstant.DATA_PROCESSOR, "io.mosip.packet.data.dataprocessor.MosipPacketDTOProcessor"),
    MOSIP_UGANDA_EC_MAPPER(ProcessorConstant.DATA_PROCESSOR, "io.mosip.packet.data.dataprocessor.UgandaECExtractor"),
