...
import io.mosip.packet.core.constant.DateUtilConstants;
import io.mosip.packet.core.exception.IllegalArgumentException;
import io.mosip.packet.core.exception.NullPointerException;
...
public final class DateUtils {
	...
	public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
		...
		try {
			...
			throw new io.mosip.packet.core.exception.ParseException(
