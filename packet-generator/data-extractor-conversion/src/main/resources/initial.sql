...
CREATE TABLE "MOSIP"."PACKET_TRACKER" ("RUN_INSTANCE_ID" VARCHAR(100) NOT NULL, "SESSION_ID" VARCHAR(100) NOT NULL, "REF_ID" VARCHAR(100) NOT NULL, "REG_NO" VARCHAR(100), "ACTIVITY" VARCHAR(50), "STATUS" VARCHAR(50), "PROCESS" VARCHAR(50) NOT NULL, "REQUEST" CLOB, "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP);
...
ALTER TABLE "MOSIP"."PACKET_TRACKER" ADD CONSTRAINT "PK_REF_ID" PRIMARY KEY ("RUN_INSTANCE_ID", "REF_ID");

CREATE INDEX IX_PACKET_TRACKER ON "MOSIP"."PACKET_TRACKER" ("REF_ID", "ACTIVITY", "RUN_INSTANCE_ID");

CREATE INDEX IX_PACKET_TRACKER_SESSION ON "MOSIP"."PACKET_TRACKER" ("SESSION_ID");
